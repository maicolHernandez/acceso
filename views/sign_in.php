    ...
    <div class="wrapper">
        ...
        <form class="p-3 mt-3">
            ...
            <div class="form-field d-flex align-items-center"> <span class="fas fa-key"></span> <input type="password" name="password" id="pwd" placeholder="Password"> </div>
             <a href="index.php?page=views/home_index.php" class="btn mt-3">Iniciar sesión</a>
        </form>
        <div class="text-center fs-6"> <a href="#">Olvido su contraseña</a> o <a href="index.php?page=views/sign_up.html">Registrarse</a> </div>
    </div>
