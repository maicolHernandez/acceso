...
<table class="main-table-frame">
	...
	<tr class="main-table-frame-menu-bar">
		<td class="main-table-frame-menu-bar" colspan="2">
			...
			|
			<a href="index.php?page=views/home_index.php" style="color:coral; font-size:18px; text-decoration:none;" >Nueva versión Mutillidae proyecto frontend Politécnico Grancolombiano</a>
		</td>
	</tr>
	<tr>
